...
<head>
    ...
    <script>
        function checkIdAndName() {
            var forgetId = $("#forgot_id").val();
            var forgetName = $("#forgot_name").val();
            if (forgetId!=null&&forgetId!=''&&forgetName!=null&&forgetName!=''){
                $.ajax({
    ...
    <div class="tab-content">
        <div id="login" class="tab-pane active">
            ...
            <ul class="list-inline" id="link">
                <li><a class="text-muted" href="#" onclick="showRegister()" data-toggle="tab">注册账号
                </a></li>
        ...
        <div id="signup" class="tab-pane">
            <%--提交到指定的地方--%>
            <form name="registerForm" action="${pageContext.request.contextPath}/manager/managerRegister.action" method="post" onsubmit="return registerCheck(this)">
