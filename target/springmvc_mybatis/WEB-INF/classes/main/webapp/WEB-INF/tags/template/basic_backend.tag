...
<head>
    ...
    <link rel="stylesheet"
          href="${pageContext.request.contextPath}/resource/static/assets/bootstrap/3.3.7/css/bootstrap.min.css">
    <!-- font-awesome -->
    <link rel="stylesheet"
          href="${pageContext.request.contextPath}/resource/static/assets/font-awesome/4.7.0/css/font-awesome.min.css">
    <!-- bootstrap table-->
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resource/static/assets/bootstrap-table/1.12.1/bootstrap-table.min.css">

    <!-- metis Menu-->
    <link rel="stylesheet"
          href="${pageContext.request.contextPath}/resource/static/assets/metismenu/3.0.3/metisMenu.min.css">
    <link rel="stylesheet"
          href="${pageContext.request.contextPath}/resource/static/assets/metismenu/3.0.3/css/mm-vertical.css">
    <link rel="shortcut icon" href="${pageContext.request.contextPath}/resource/static/img/favico.ico"/>
    <link rel="bookmark" href="${pageContext.request.contextPath}/resource/static/img/favico.ico"/>


    <!-- 站点 自定义 样式 -->
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resource/static/css/site.css">
...
<script src="${pageContext.request.contextPath}/resource/static/assets/bootstrap/3.3.7/js/bootstrap.min.js"></script>
<!-- metisMenu -->
<script src="${pageContext.request.contextPath}/resource/static/assets/metismenu/3.0.3/metisMenu.min.js"></script>
<!-- 站点 自定义 函数库 -->
<script src="${pageContext.request.contextPath}/resource/static/js/site.js"></script>
